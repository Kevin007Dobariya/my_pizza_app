...
UpdateProfileModel updateProfileModelFromMap(String str) => UpdateProfileModel.fromMap(json.decode(str));

String updateProfileModelToMap(UpdateProfileModel data) => json.encode(data.toMap());
