...
AddPasswordModel addPasswordModelFromMap(String str) => AddPasswordModel.fromMap(json.decode(str));

String addPasswordModelToMap(AddPasswordModel data) => json.encode(data.toMap());
...
class AddPasswordModel {
  ...
  factory AddPasswordModel.fromMap(Map<String, dynamic> json) => AddPasswordModel(
